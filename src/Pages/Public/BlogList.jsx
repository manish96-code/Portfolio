                    ...
                    <div className="flex flex-wrap gap-3">
                        {categories.map((cat, idx) => (
                            <button
                                ...
                                className={`px-4 py-2 rounded-wobbly text-sm font-bold border-2 border-stone transition-hand shadow-hard-muted ${selectedCategory === cat
                    ...
                    {filteredBlogs.length > 0 ? (
                        filteredBlogs.map((blog, idx) => {
                            ...
                            return (
                                <article
                                    key={blog.id}
                                    className={`bg-white border-3 border-stone p-8 flex flex-col justify-between rounded-wobbly-md card-tape hover:shadow-hard hover:rotate-0 transition-hand group shadow-hard-muted relative ${idx % 2 === 0 ? 'rotate-1' : '-rotate-1'
                                        }`}
                                >
